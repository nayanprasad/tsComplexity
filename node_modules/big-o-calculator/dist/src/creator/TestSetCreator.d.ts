...
import { AlgorithmSpeed, AnalysisTestSet, Code, Language } from "../structures";
import { CodeTransformerFunction } from "../transformer";
declare class TestSetCreator {
    static DEFAULT_SAMPLES: number[];
    private argumentGenerator;
    private codeTransformer;
    constructor();
    private languageSampleSizesBySpeed;
    private languageDefaultSampleSizes;
